...
// reference to the array, passed in as an argument value
...
function user_location_input(event) {
  ...
  // this for every one of the input elements! console.log('Location is:',
  // location, 'Min. Hourly Customers are:', min_hourly_customer, 'Max. Hourly
  // Customers are:', max_hourly_customer, 'Avg. Cookies Purchased Per Customer
