...
// Use a method of each city object literal to generate a random number of
// customers per hour.
...
let seattle = {
  ...
  // Use a method of that object to generate a random number of customers per
  // hour.
  random_number_of_customers : function(min_hourly_customer,
                                        max_hourly_customer) {
  ...
  // Calculate and store the simulated amounts of cookies purchased for each
  // hour at each location using average cookies purchased and the random
  ...
  simulated_amounts_of_cookies_purchased : function() {
    for (let i = 0; i < hours_of_operation.length; i++) {
      let simulated_amount =
          Math.round(this.random_number_of_customers(this.min_hourly_customer,
                                                     this.max_hourly_customer) *
                     this.avg_cookie_per_customer);
      console.log(simulated_amount);
      this.simulated_amounts_of_cookies_purchased_for_seattle.push(
          simulated_amount);
  ...
  display_values : function() {
    ...
    // Create list item element for every hour, from hours of operation global
    // array
    let seattle_display = document.getElementById('seattle');
    for (let i = 0; i < hours_of_operation.length; i++) {
      let list_item_element = document.createElement('li');
      list_item_element.innerText = `${hours_of_operation[i]}: ${
          this.simulated_amounts_of_cookies_purchased_for_seattle[i]}`;
...
let tokyo = {
    ...
    for (let i = 0; i < hours_of_operation.length; i++) {
      let simulated_amount =
          Math.round(this.random_number_of_customers(this.min_hourly_customer,
                     ...
                     this.avg_cookie_per_customer);
      console.log(simulated_amount);
      this.simulated_amounts_of_cookies_purchased_for_tokyo.push(
          simulated_amount);
      this.total_cookies_sold += simulated_amount;
  ...
  display_values : function() {
    ...
    for (let i = 0; i < hours_of_operation.length; i++) {
      let list_item_element = document.createElement('li');
      list_item_element.innerText = `${hours_of_operation[i]}: ${
          this.simulated_amounts_of_cookies_purchased_for_tokyo[i]}`;
...
let dubai = {
    ...
    for (let i = 0; i < hours_of_operation.length; i++) {
      let simulated_amount =
          Math.round(this.random_number_of_customers(this.min_hourly_customer,
                     ...
                     this.avg_cookie_per_customer);
      console.log(simulated_amount);
      this.simulated_amounts_of_cookies_purchased_for_dubai.push(
          simulated_amount);
      this.total_cookies_sold += simulated_amount;
  ...
  display_values : function() {
    ...
    for (let i = 0; i < hours_of_operation.length; i++) {
      let list_item_element = document.createElement('li');
      list_item_element.innerText = `${hours_of_operation[i]}: ${
          this.simulated_amounts_of_cookies_purchased_for_dubai[i]}`;
...
let paris = {
    ...
    for (let i = 0; i < hours_of_operation.length; i++) {
      let simulated_amount =
          Math.round(this.random_number_of_customers(this.min_hourly_customer,
                     ...
                     this.avg_cookie_per_customer);
      console.log(simulated_amount);
      this.simulated_amounts_of_cookies_purchased_for_paris.push(
          simulated_amount);
      this.total_cookies_sold += simulated_amount;
  ...
  display_values : function() {
    ...
    for (let i = 0; i < hours_of_operation.length; i++) {
      let list_item_element = document.createElement('li');
      list_item_element.innerText = `${hours_of_operation[i]}: ${
          this.simulated_amounts_of_cookies_purchased_for_paris[i]}`;
...
let lima = {
    ...
    for (let i = 0; i < hours_of_operation.length; i++) {
      let simulated_amount =
          Math.round(this.random_number_of_customers(this.min_hourly_customer,
                     ...
                     this.avg_cookie_per_customer);
      console.log(simulated_amount);
      this.simulated_amounts_of_cookies_purchased_for_lima.push(
          simulated_amount);
      this.total_cookies_sold += simulated_amount;
  ...
  display_values : function() {
    ...
    for (let i = 0; i < hours_of_operation.length; i++) {
      let list_item_element = document.createElement('li');
      list_item_element.innerText = `${hours_of_operation[i]}: ${
          this.simulated_amounts_of_cookies_purchased_for_lima[i]}`;
